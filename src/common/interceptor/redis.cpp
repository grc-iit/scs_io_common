...
namespace sw {
    ...
    namespace redis {
        ...
        public:
            ...
            long long
            bitop(BitOp op, const StringView &destination, const StringView &key);
            ...
            template<typename T>
            long long
            bitop(BitOp op, const StringView &destination, std::initializer_list<T> il) {
            ...
            OptionalStringPair blpop(const StringView &key,
                                                           const std::chrono::seconds &timeout = std::chrono::seconds{
                                                                   0});
            ...
            OptionalString
            rpoplpush(const StringView &source, const StringView &destination);
            ...
            long long
            hincrby(const StringView &key, const StringView &field, long long increment);
            ...
            bool
            hset(const StringView &key, const StringView &field,
                 const StringView &val);

            bool
            hset(const StringView &key, const std::pair<StringView, StringView> &item);
            ...
            bool
            hsetnx(const StringView &key, const StringView &field,
                   const StringView &val);

            bool
            hsetnx(const StringView &key,
                   const std::pair<StringView, StringView> &item);
            ...
            long long
            zinterstore(const StringView &destination, const StringView &key, double weight);
            ...
            long long
            zunionstore(const StringView &destination, const StringView &key, double weight);
            ...
            geopos(const StringView &key, const StringView &member);
            ...
            long long
            xack(const StringView &key, const StringView &group, const StringView &id);

            template<typename Input>
            long long
            xack(const StringView &key, const StringView &group, Input first, Input last);

            template<typename T>
            long long
            xack(const StringView &key, const StringView &group, std::initializer_list<T> il) {
                return xack(key, group, il.begin(), il.end());
            }

            template<typename Input>
            std::string
            xadd(const StringView &key, const StringView &id, Input first, Input last);

            template<typename T>
            std::string
            xadd(const StringView &key, const StringView &id, std::initializer_list<T> il) {
            ...
            void xgroup_setid(const StringView &key, const StringView &group,
                              const StringView &id);
